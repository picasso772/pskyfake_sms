...
import kotlinx.android.synthetic.main.message_chat_friend_show.view.*
import kotlinx.android.synthetic.main.message_chat_me.view.*

class MessagesShowChatAdapter(var items: MutableList<MessageChat>, val context: Context?) :
    ...
    override fun onCreateViewHolder(p0: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return when (viewType) {
            ...
            TYPE_ITEM_ME -> {
                view = LayoutInflater.from(context).inflate(R.layout.message_chat_me_show, p0, false)
                MessageMeViewHolder(view)
            }
            TYPE_ITEM_FRIEND -> {
                view = LayoutInflater.from(context).inflate(R.layout.message_chat_friend_show, p0, false)
