...
import kotlinx.android.synthetic.main.item_list_messages.view.*
import java.io.File

class MessagesAdapter(val users: MutableList<User>, val context: Context?) :
    RecyclerSwipeAdapter<MessagesAdapter.MessagesViewHolder>() {
    ...
    var holders: MutableList<MessagesViewHolder> = mutableListOf()

    override fun getSwipeLayoutResourceId(position: Int): Int {
        return R.id.swipe
    }

    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): MessagesViewHolder {
        return MessagesViewHolder(LayoutInflater.from(context).inflate(R.layout.item_list_messages, parent, false))
    }
    ...
    override fun onBindViewHolder(holder: MessagesViewHolder, position: Int) {
        ...
        holder.timeMessages.text = Utils.shared.formatDateToStringShowMessages(users[position].timeMessages ?: 0L)
