...
class LineAdapter(var users: MutableList<User>, val context: Context?) :
    RecyclerSwipeAdapter<LineAdapter.LineViewHolder>() {
    ...
    var holders: MutableList<LineViewHolder> = mutableListOf()

    override fun getSwipeLayoutResourceId(position: Int): Int {
        return R.id.swipe
    }

    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): LineViewHolder {
        return LineViewHolder(LayoutInflater.from(context).inflate(R.layout.item_list_line, parent, false))
    }
