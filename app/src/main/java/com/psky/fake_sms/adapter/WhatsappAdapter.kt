...
import kotlinx.android.synthetic.main.item_list_whatsapp.view.*
import java.io.File

class WhatsappAdapter(val users: MutableList<User>, val context: Context?) :
    RecyclerSwipeAdapter<WhatsappAdapter.WhatsappViewHolder>() {
    ...
    var holders: MutableList<WhatsappViewHolder> = mutableListOf()

    override fun getSwipeLayoutResourceId(position: Int): Int {
        return R.id.swipe
    }

    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): WhatsappViewHolder {
        return WhatsappViewHolder(LayoutInflater.from(context).inflate(R.layout.item_list_whatsapp, parent, false))
    }
    ...
    class WhatsappViewHolder(view: View) : RecyclerView.ViewHolder(view) {
