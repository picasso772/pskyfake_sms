...
import com.psky.fake_sms.adapter.WechatAdapter
...
import kotlinx.android.synthetic.main.show_list_wechat_view.*

class ShowListWechatView : BaseFragment(), ItemClick {
    private lateinit var adapter: WechatAdapter
    private lateinit var viewContent: View

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        DataUtils.shared.backID = 8
        ...
        adapter = WechatAdapter(DataUtils.shared.users?.toMutableList() ?: mutableListOf(), context = context)
    ...
    @OnClick(R.id.buttonBack) fun actionBack() {
        ...
        (fragmentManager?.fragments?.last() as ShowListWechatView).animationHideView()
    }
